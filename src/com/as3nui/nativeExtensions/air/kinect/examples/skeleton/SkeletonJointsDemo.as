    ...
    public function render():void {
        ...
        for (var i:int = 0; i < numJoints; i++) {
            ...
            if(i == 3) {
                    ...
                    maxdistance = joint.position.depth.x;

             //trace(joint.name + "|" + joint.position.depthRelative.x + "|" + joint.position.worldRelative.x +"|" + joint.position.depth.x );

              trace(user.head.position.world.z);
